...
import com.jemrcode.service.BuscadorDeReuniones;
...
public class EventoPlus {
    ...
    private static final BuscadorDeReuniones buscadorReuniones = new BuscadorDeReuniones();
    ...
    private static void mostrarMenu() {
        ...
        System.out.println("6. Registrar reunion");
        System.out.println("7. Listar reuniones");
        System.out.println("8. Buscar reunion por nombre");
        System.out.println("9. Buscar reunion por fecha");
    ...
    private static void procesarOpcion(int opcion) {
        switch (opcion) {
            ...
            case 6 -> {
                System.out.print("Nombre de la reunion: ");
                String nombre = scanner.nextLine();
                System.out.print("Fecha (dd/mm/yyyy): ");
                String fecha = scanner.nextLine();
                buscadorReuniones.registrarReunion(nombre, fecha);
            }
            case 7 -> buscadorReuniones.listarReuniones();
            case 8 -> {
                System.out.print("Ingrese el nombre: ");
                String nombre = scanner.nextLine();
                buscadorReuniones.buscarPorNombre(nombre);
            }
            case 9 -> {
                System.out.print("Ingrese la fecha (dd/mm/yyyy): ");
                String fecha = scanner.nextLine();
                buscadorReuniones.buscarPorFecha(fecha);
            }
            case 10 -> {
                System.out.print("Ingrese el nombre de la reunion a eliminar: ");
                String nombre = scanner.nextLine();
                buscadorReuniones.eliminarReunion(nombre);
            }
    ...
    private static void inscribirParticipanteEnEvento() {
        ...
        if (eventoService.inscribirParticipante(idEvento, participante)) {
            ...
            System.out.println("No se pudo inscribir. El evento puede estar lleno o el participante ya esta inscrito.");
        }
    }

    private static void listarParticipantes() {
        System.out.println("\n=== LISTA DE PARTICIPANTES ===");
        var lista = participanteService.listarParticipantes();
        if (lista.isEmpty()) {
    ...
    private static void listarEventos() {
        System.out.println("\n=== LISTA DE EVENTOS ===");
        var lista = eventoService.listarEventos();
        if (lista.isEmpty()) {
